...
# 2026-08-08 — the port differs per host (<linux-host> 36301, <work-mac>
# 53749, <personal-mac> 59857), so no constant works. And a name is worse than
# useless: `lsof | grep python | head -1` returned 19801 on <personal-mac>, a
